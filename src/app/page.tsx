    ...
    <div className="min-h-screen bg-[#F4F3EE] font-sans selection:bg-[#a299af]/30 selection:text-[#0c0e0b] flex flex-col overflow-x-hidden w-full relative">
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative overflow-hidden w-full py-12 md:py-0">
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10 w-full pt-8 sm:pt-0">
          ...
          {/* Scroll Hint */}
          <div className="py-4 flex items-center justify-center -mb-4">
            <AnimatePresence>
              {isConnected && (
                <motion.button
          ...
          {/* Hero Definition (SEO) */}
          <div className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto space-y-4 pt-4 sm:pt-6 md:pt-20 lg:pt-32 shrink-0 px-2 lg:px-0">
            <motion.h1 
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 md:px-12 max-w-3xl mx-auto text-center relative z-10">
        <motion.div
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24 w-full max-w-6xl">
               ...
               <AnimatePresence mode="wait">
                 {circleView === 'public' ? (
                   <motion.div
                     ...
                     className="flex-1 w-full relative flex flex-col items-center justify-center p-6 bg-[#0c0e0b] overflow-y-auto scrollbar-hide"
                   >
                      {/* Header */}
                      ...
                      <div className="relative w-[180px] h-[180px] flex items-center justify-center mb-6 shrink-0">
                        {/* Center Circle Name */}
                              ...
                              >
                                <div
                                  ...
                                  style={{ 
                                    ...
                                    boxShadow: `0 0 15px ${color}, inset 0 0 8px rgba(255,255,255,0.6)`,
                                  }}
                                />
                              </div>
                            );
                   ...
                   <motion.div
                     ...
                     exit={{ opacity: 0 }}
                     transition={{ duration: 0.3 }}
                     className="flex-1 w-full relative flex flex-col items-center text-center bg-[#0c0e0b] text-white overflow-hidden scrollbar-hide"
                   >
          ...
          <div className="text-center lg:text-left max-w-xl flex flex-col items-center lg:items-start px-4 shrink-0">
            <h2 className="font-semibold tracking-tight text-[#0c0e0b] mb-4 leading-tight flex flex-col items-center lg:items-start">
              <span className="text-[22px] min-[400px]:text-2xl sm:text-3xl md:text-4xl">Circle Resonance</span>
            </h2>
            ...
            >
              Start a Circle <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 flex flex-col items-start text-left max-w-lg mx-auto lg:mx-0">
            <h2 className="font-semibold tracking-tight text-[#0c0e0b] mb-6 leading-tight flex flex-col">
              <span className="text-[22px] min-[400px]:text-2xl sm:text-3xl md:text-4xl">Just Tap. That’s It.</span>
            </h2>
            ...
            <ul className="space-y-4 mb-8 w-full">
              {[
                { title: 'NFC Wristband', desc: 'Just tap your wristband to any phone and your identity opens instantly.' },
                { title: 'Dynamic Profile', desc: 'Update your links, contacts, and content anytime.' },
                { title: 'Privacy First', desc: 'You control what you share, always.' }
              ].map((item, i) => (
      ...
      <footer className="relative pt-24 pb-20 px-4 sm:px-6 md:px-12 mt-auto overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="bg-white rounded-[2.5rem] border border-[#0c0e0b]/5 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.05)] p-8 md:p-12 lg:p-16">
            <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-24 mb-16">
              ...
              <div className="max-w-xs">
                <Link href="/" className="flex items-center gap-2 mb-6 group">
                  ...
                  <span className="font-bold text-2xl tracking-tight text-[#0c0e0b]">Rifelo</span>
                </Link>
                <p className="text-sm text-[#0c0e0b]/50 leading-relaxed font-medium mb-8">
                  Designing the future of intentional connections. Rifelo is an NFC-powered digital identity platform for modern networking and real-time interaction.
                </p>
                <div className="flex gap-5">
                  <Link href="https://twitter.com" target="_blank" className="text-[#0c0e0b]/40 hover:text-[#0c0e0b] transition-colors">
                    <Twitter className="w-5 h-5" />
                  </Link>
                  <Link href="https://instagram.com/rifelo.id" target="_blank" className="text-[#0c0e0b]/40 hover:text-[#0c0e0b] transition-colors">
                    <Instagram className="w-5 h-5" />
                  </Link>
                  <Link href="https://linkedin.com" target="_blank" className="text-[#0c0e0b]/40 hover:text-[#0c0e0b] transition-colors">
                    <Linkedin className="w-5 h-5" />
                  </Link>
                  <Link href="https://github.com" target="_blank" className="text-[#0c0e0b]/40 hover:text-[#0c0e0b] transition-colors">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-12">
                {/* Product */}
                <div>
                  <h4 className="font-bold text-[#0c0e0b] mb-6 text-sm">Product</h4>
                  <ul className="space-y-4 text-sm text-[#0c0e0b]/50 font-medium">
                    ...
                    <li><Link href="/join-rifelo" className="hover:text-[#0c0e0b] transition-colors">Integrations</Link></li>
                  </ul>
                </div>

                {/* Support */}
                <div>
                  <h4 className="font-bold text-[#0c0e0b] mb-6 text-sm">Support</h4>
                  <ul className="space-y-4 text-sm text-[#0c0e0b]/50 font-medium">
                ...
                {/* Legal */}
                <div>
                  <h4 className="font-bold text-[#0c0e0b] mb-6 text-sm">Legal</h4>
                  <ul className="space-y-4 text-sm text-[#0c0e0b]/50 font-medium">
            ...
            {/* Bottom Row */}
            <div className="pt-10 border-t border-[#0c0e0b]/5 flex flex-col md:flex-row items-center justify-between gap-6">
              <p className="text-sm text-[#0c0e0b]/40 font-medium">
                © {mounted ? new Date().getFullYear() : '2026'} Rifelo Inc. All rights reserved.
              </p>
              <div className="flex flex-wrap gap-8 text-sm font-medium">
                <Link href="/privacy" className="text-[#0c0e0b]/40 hover:text-[#0c0e0b] transition-colors">Privacy Policy</Link>
                <Link href="/terms" className="text-[#0c0e0b]/40 hover:text-[#0c0e0b] transition-colors">Terms of Service</Link>
                <button className="text-[#0c0e0b]/40 hover:text-[#0c0e0b] transition-colors font-medium">Cookies Settings</button>
              </div>
            </div>
          </div>
        </div>
